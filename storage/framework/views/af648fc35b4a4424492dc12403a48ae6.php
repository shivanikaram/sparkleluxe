...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <header class="flex justify-between items-center py-0 px-6 w-full absolute top-0 left-0 z-10 bg-opacity-50 bg-black">
        ...
        <div class="relative flex items-center">
            <a href="<?php echo e(url('/cart')); ?>" class="text-white text-2xl relative">
    ...
    <div class="relative overflow-hidden w-full h-[50vh] lg:h-[90vh] xl:h-[100vh]">
        <!-- Single Image -->
        <img src="/images/products.jpg" class="w-full h-full object-cover">
...
<!-- Main Jewelry Description -->
<div class="pt-20">
    <h2 class="text-xl font-semibold text-center md:text-xl lg:text-xl">Our Exclusive Jewelry Collections</h2>
    <div class="w-full text-center font-inria-serif-italic text-lg font-normal mt-4 py-4">
        Elevate your style with our exclusive unique jewelry pieces. Expertly crafted from rose gold, silver, diamond, and pearls. <br> Perfect for adding a touch of elegance to any outfit or occasion.
    </div>
</div>
...
<!-- Jewelry Collection Retreived from Database with alignments -->
<div>
    <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('products');

$__html = app('livewire')->mount($__name, $__params, 'lw-2546300782-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\Users\HP\sparkleluxe\resources\views/products.blade.php ENDPATH**/ ?>