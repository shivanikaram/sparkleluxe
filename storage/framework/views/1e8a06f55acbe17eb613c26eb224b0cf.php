...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <div class="flex flex-col md:flex-row items-center space-x-0 md:space-x-8 bg-white overflow-hidden max-w-4xl p-6">
        ...
        <div class="p-4 flex flex-col justify-center items-center text-center w-full sm:w-80 md:w-96">
            ...
            <br>
            <a href="<?php echo e(url('products')); ?>" class="mt-2 text-sm sm:text-base md:text-lg text-gray-700 underline hover:text-custom-gray hover:no-underline">
              View Collections
          </a>
    ...
    <div class="flex justify-center">
        <div class="bg-white overflow-hidden w-full sm:w-3/4 max-w-4xl flex flex-col">
            ...
            <div class="p-4 flex flex-col justify-center items-center text-center">
                ...
                <br>
                <a href="<?php echo e(url('/services')); ?>" class="mt-2 text-sm sm:text-base md:text-lg text-gray-700 underline hover:text-custom-gray hover:no-underline">
                     View Services
                </a>
            </div>
        </div>
...
<?php /**PATH C:\Users\HP\sparkleluxe\resources\views/welcome.blade.php ENDPATH**/ ?>