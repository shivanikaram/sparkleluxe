...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto mt-12 max-w-4xl">
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 mb-8">
            ...
            <p class="text-xl font-semibold text-right text-gray-800">Total: ${{ number_format($totalPrice, 2) }}</p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <form id="orderForm" action="{{ route('checkout.placeOrder') }}" method="POST" onsubmit="return handleSubmit(event)">
                @csrf
